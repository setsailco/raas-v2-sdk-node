...
/**
 * Creates an instance of GetDepositResponseModel
 */
class GetDepositResponseModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'createdDate', realName: 'createdDate' },
...
module.exports = GetDepositResponseModel;
