...
class OrdersController {
    ...
    static getOrder(referenceOrderID, callback) {
        ...
        let _pathUrl = '/orders/{referenceOrderID}';
     ...
     * @param {string} input['referenceOrderID'] The order's reference order id
     * @param {OrderResendCriteriaModel} input['orderResendCriteria'] (optional) TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createResendOrder(input, callback) {
        ...
        if (input.referenceOrderID === null || input.referenceOrderID === undefined) {
            const _err = { errorMessage: 'The property `referenceOrderID` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        let _pathUrl = '/orders/{referenceOrderID}/resends';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
        ...
        // remove null values
        _apiHelper.cleanObject(input.orderResendCriteria);
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.orderResendCriteria),
            username: _configuration.platformName,
            password: _configuration.platformKey,
        };
    ...
    static getOrders(input, callback) {
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            ...
            startDate: _apiHelper.stringifyDateTime(input.startDate, 'rfc3339'),
            endDate: _apiHelper.stringifyDateTime(input.endDate, 'rfc3339'),
